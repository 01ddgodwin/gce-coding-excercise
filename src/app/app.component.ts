...
export class AppComponent {
  ...
  constructor() {
    ...
    if (this.selectedMonth === null || this.selectedDay === null || this.yearInput === null) {
  ...
  date: Date = new Date(this.selectedDate);  dateDifference: number = (this.date.getTime() - this.currentDate.getTime()) / (1000 * 3600 * 24) + 1;

  // When the inputs change, this function will run updating up the variables
  updateDate() {
    this.selectedDate = this.selectedMonth + '/' + this.selectedDay + '/' + this.yearInput;
